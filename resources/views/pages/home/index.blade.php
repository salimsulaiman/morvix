...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-8 pt-8 pb-8">
            ...
            flex items-center justify-center">
                                ...
                                <img src="{{ asset('assets/images/product/car/kijang-inova.png') }}" alt=""
                                    class="relative z-30 w-full object-center">
                            </div>
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="mx-auto grid grid-cols-3 justify-center mt-8 gap-20">
                <div class="flex flex-col gap-4 text-center">
                    <h3 class="text-7xl text-lime-600 font-semibold">2000<span class="text-5xl">+</span></h3>
                    <h6 class="text-slate-500 text-sm font-medium">Active Member</h6>
                </div>
                <div class="flex flex-col gap-4 text-center">
                    <h3 class="text-7xl text-lime-600 font-semibold">50<span class="text-5xl">+</span></h3>
                    <h6 class="text-slate-500 text-sm font-medium">Car Model</h6>
                </div>
                <div class="flex flex-col gap-4 text-center">
                    <h3 class="text-7xl text-lime-600 font-semibold">100<span class="text-5xl">+</span></h3>
                    <h6 class="text-slate-500 text-sm font-medium">Positive Rating</h6>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="mt-8 w-full grid grid-cols-4 gap-4">
                @for ($i = 0; $i < 4; $i++)
                    <div class="w-full bg-slate-100 rounded-2xl aspect-[3/4] overflow-hidden relative group">
                        ...
                        <div class="absolute inset-0 bg-cover bg-bottom z-0"
                            style="background-image: url('{{ asset('assets/images/background-patern.jpg') }}');">
                        </div>
                ...
                @for ($i = 0; $i < 8; $i++)
                    <div class="w-full bg-lime-500 rounded-2xl aspect-[3/4] overflow-hidden relative group">
                        ...
                        <div class="w-full h-full relative overflow-hidden">
                            ...
                            <div class="absolute inset-0 z-20 flex flex-col gap-4 justify-between">
                                <div class="flex flex-col w-full gap-1 p-4">
                                    <h4 class="text-slate-950 text-base line-clamp-1 font-bold">Honda Vixion</h4>
                                    <div class="flex gap-2">
    ...
    <section class="bg-white w-full">
        <div class="mx-auto max-w-7xl px-8 pt-16 pb-8">
            ...
            <swiper-container class="mySwiper mt-8" slides-per-view="3" space-between="30" pagination="true"
                    ...
                    <swiper-slide>
                        <div class="w-full aspect-[5/6] bg-slate-800 rounded-3xl relative overflow-hidden flex items-end">
                            <img src="{{ asset('assets/icons/quotation.png') }}" alt=""
                                class="absolute z-0 top-8 left-10 w-24">

                            <div class="w-full p-8 relative z-10 flex flex-col gap-6">
                                <p class="text-white">{{ $item['text'] }}</p>

                                <div class="w-full flex flex-row gap-4 items-center">
                                    <div class="h-14 w-14 rounded-full bg-white shrink-0 overflow-hidden relative">
                                        <img src="{{ asset($item['avatar']) }}" alt=""
                                            class="w-full h-full object-center object-cover">
                                    </div>

                                    <div class="flex flex-col gap-[2px]">
                                        <h4 class="text-white text-lg font-semibold">{{ $item['name'] }}</h4>
                                        <h6 class="text-slate-300 text-xs">{{ $item['job'] }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="max-w-7xl mx-auto mb-16 mt-4 px-8">
