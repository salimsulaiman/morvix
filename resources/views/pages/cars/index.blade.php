...
@section('content')
    ...
    <div class="min-h-screen bg-slate-50">
        <div class="max-w-7xl mx-auto p-6 grid grid-cols-1 md:grid-cols-4 gap-6" x-data="{ minPrice: 200000, maxPrice: 800000 }">

            <!-- ======== ASIDE FILTER ======== -->
            <aside class="bg-white rounded-3xl shadow p-5 space-y-6">
            ...
            <section class="md:col-span-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 h-fit">
                <div class="w-full flex flex-col gap-4 col-span-full">
                    <div class="bg-white h-40 rounded-4xl flex flex-col shadow gap-4 p-8 justify-center">
                ...
                <!-- Product Card Dummy -->
                @for ($i = 0; $i < 4; $i++)
                    <div class="w-full bg-white rounded-3xl aspect-[3/4] overflow-hidden relative group shadow">
                        <div class="w-full h-full relative overflow-hidden">
                            <div
                                class="w-full h-full bg-white flex items-center justify-center overflow-hidden group-hover:scale-110 duration-500 transition-all">
                            ...
                            <a href="">
                                <div class="absolute inset-0 z-20 flex flex-col gap-4 justify-between">
                                    <div class="w-full flex gap-2 p-6">
                                        <div class="flex flex-col w-full gap-1">
                                            <h4 class="text-slate-900 text-base line-clamp-1 font-bold">Kijang Inova</h4>
                                            <div class="flex gap-2">
                                                <h6 class="text-xs font-semibold text-slate-600">
                                                    Sport</h6>
                                            </div>
                                        </div>
                                        <i data-feather="heart" class="h-4"></i>
                                    </div>
                                    <div class="flex flex-col gap-2 w-full">
                                        <div class="flex gap-4 px-6 pb-2 pt-2 w-full justify-start">
                                            <div class="flex gap-1 items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                                    class="w-3 h-3 text-slate-500" fill="currentColor">
                                                    <path
                                                ...
                                                <span class="text-slate-500 text-xs font-semibold">6</span>
                                            </div>
                                            <div class="flex gap-2 items-center">
                                                ...
                                                <span
                                                    class="text-slate-500 text-xs font-semibold uppercase">Manually</span>
                                            </div>
                                            <div class="flex gap-1 items-center">
                                        ...
                                        <div class="flex w-full justify-between gap-2 px-6 pb-6 items-end">
