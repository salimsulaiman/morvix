                        ...
                        <div class="relative p-4 w-full max-w-2xl max-h-full">
                            ...
                            <div class="relative bg-white border border-default rounded-base shadow-sm p-4 md:p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 py-4 md:py-6">
                                    ...
                                    <div>
                                        <h3 class="text-sm font-semibold text-slate-600 mb-2 uppercase tracking-wide">
                                            Kategori Motor
                                        </h3>
                                        <div class="space-y-1 text-slate-700">
                                            <label class="flex items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-1 text-slate-700">
                                            <label class="flex items-center gap-2">
                                                <input type="checkbox" class="text-lime-600 focus:ring-lime-400">
                                                Automatic
                                            </label>
                                            <label class="flex items-center gap-2">
                                                <input type="checkbox" class="text-lime-600 focus:ring-lime-400"> Manual
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-2 text-slate-700">
                                            <label class="flex items-center gap-2">
                                                <input type="checkbox" class="text-lime-600 focus:ring-lime-400"> ABS
                                            </label>
                                            <label class="flex items-center gap-2">
                                                <input type="checkbox" class="text-lime-600 focus:ring-lime-400"> Smart
                                                Key
                                            </label>
                                            <label class="flex items-center gap-2">
                                                <input type="checkbox" class="text-lime-600 focus:ring-lime-400">
                                            ...
                                            <label class="flex items-center gap-2">
                                                <input type="checkbox" class="text-lime-600 focus:ring-lime-400"> Traction
                                                Control
                                            </label>
                                            <label class="flex items-center gap-2">
                                                <input type="checkbox" class="text-lime-600 focus:ring-lime-400"> LED
                                                Headlight
                                            </label>
                                        </div>
                                    </div>
